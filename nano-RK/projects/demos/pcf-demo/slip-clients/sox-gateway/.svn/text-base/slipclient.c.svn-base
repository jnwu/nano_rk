...
void my_publish_success_callback(void)
{
  // This is a callback setup for when publication is successful. 
  // Use this to determine if SOX has stopped correctly publishing 
  sw_watchdog_reset();
}
#endif
...
#ifdef USE_SOX
sox_callback_set_publish_success(&my_publish_success_callback );
#endif
